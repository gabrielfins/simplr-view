...
import { MdPerson, MdAssignmentInd, MdAttachMoney, MdSettings, MdInfoOutline } from 'react-icons/md';
    ...
    return (
        <nav className={styles.navbar}>
            ...
            <div className={styles.navLinks}>
                <NavLink className={styles.navLink} exact to="/"><MdAttachMoney className={styles.linkIcon} size="2.4rem" />Vendas</NavLink>
